...
bool Version::validate(std::stringstream& msg,
  ...
  if (resourcesIsSet()) {
    ...
    {  // Recursive validation of array elements
      ...
      for (const Resource& value : value) {
        ...
        success =
            value.validate(msg, currentValuePath + ".resources") && success;
  ...
  if (custOperationsIsSet()) {
    ...
    {  // Recursive validation of array elements
      ...
      for (const CustomOperation& value : value) {
        ...
        success = value.validate(msg, currentValuePath + ".custOperations") &&
                  success;
...
bool Version::operator==(const Version& rhs) const {
  return
      ...
      ((!resourcesIsSet() && !rhs.resourcesIsSet()) ||
       (resourcesIsSet() && rhs.resourcesIsSet() &&
        getResources() == rhs.getResources())) &&

      ((!custOperationsIsSet() && !rhs.custOperationsIsSet()) ||
       (custOperationsIsSet() && rhs.custOperationsIsSet() &&
        getCustOperations() == rhs.getCustOperations()))
...
std::vector<Resource> Version::getResources() const { return m_Resources; }
