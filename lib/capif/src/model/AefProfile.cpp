...
bool AefProfile::validate(std::stringstream& msg,
                          const std::string& pathPrefix) const {
  bool success = true;
  const std::string _pathPrefix =
      pathPrefix.empty() ? "AefProfile" : pathPrefix;
  ...
  if (interfaceDescriptionsIsSet()) {
    ...
    {  // Recursive validation of array elements
      ...
      for (const InterfaceDescription& value : value) {
        ...
        success =
            value.validate(msg, currentValuePath + ".interfaceDescriptions") &&
            success;
...
bool AefProfile::operator==(const AefProfile& rhs) const {
  return
      ...
      ((!dataFormatIsSet() && !rhs.dataFormatIsSet()) ||
       (dataFormatIsSet() && rhs.dataFormatIsSet() &&
      ...
      ((!interfaceDescriptionsIsSet() && !rhs.interfaceDescriptionsIsSet()) ||
       (interfaceDescriptionsIsSet() && rhs.interfaceDescriptionsIsSet() &&
        getInterfaceDescriptions() == rhs.getInterfaceDescriptions()))
...
void to_json(nlohmann::json& j, const AefProfile& o) {
  ...
  if (o.dataFormatIsSet()) j["dataFormat"] = o.m_DataFormat;
...
std::vector<Version> AefProfile::getVersions() const { return m_Versions; }
