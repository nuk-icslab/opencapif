...
#include "capif/model/Resource.h"
...
bool Resource::validate(std::stringstream& msg,
...
bool Resource::operator==(const Resource& rhs) const {
  return
      ...
      ((!custOpNameIsSet() && !rhs.custOpNameIsSet()) ||
       (custOpNameIsSet() && rhs.custOpNameIsSet() &&
...
bool Resource::operator!=(const Resource& rhs) const { return !(*this == rhs); }
...
void to_json(nlohmann::json& j, const Resource& o) {
  ...
  j["uri"] = o.m_Uri;
  if (o.custOpNameIsSet()) j["custOpName"] = o.m_CustOpName;
...
std::vector<Operation> Resource::getOperations() const { return m_Operations; }
