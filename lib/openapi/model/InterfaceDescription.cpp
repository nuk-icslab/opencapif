...
bool InterfaceDescription::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "InterfaceDescription" : pathPrefix;
...
std::string InterfaceDescription::getIpv4Addr() const
{
    return m_Ipv4Addr;
}
...
bool InterfaceDescription::ipv4AddrIsSet() const
{
    return m_Ipv4AddrIsSet;
}
void InterfaceDescription::unsetIpv4Addr()
{
    m_Ipv4AddrIsSet = false;
}
std::string InterfaceDescription::getIpv6Addr() const
{
    return m_Ipv6Addr;
}
...
bool InterfaceDescription::ipv6AddrIsSet() const
{
    return m_Ipv6AddrIsSet;
}
void InterfaceDescription::unsetIpv6Addr()
{
    m_Ipv6AddrIsSet = false;
}
int32_t InterfaceDescription::getPort() const
{
    return m_Port;
}
...
bool InterfaceDescription::portIsSet() const
{
    return m_PortIsSet;
}
void InterfaceDescription::unsetPort()
{
    m_PortIsSet = false;
}
...
void InterfaceDescription::setSecurityMethods(std::vector<SecurityMethod> const& value)
{
