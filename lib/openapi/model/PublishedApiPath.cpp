...
bool PublishedApiPath::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "PublishedApiPath" : pathPrefix;
...
bool PublishedApiPath::operator==(const PublishedApiPath& rhs) const
{
    ...
    ((!ccfIdsIsSet() && !rhs.ccfIdsIsSet()) || (ccfIdsIsSet() && rhs.ccfIdsIsSet() && getCcfIds() == rhs.getCcfIds()))
...
bool PublishedApiPath::ccfIdsIsSet() const
{
    return m_CcfIdsIsSet;
}
void PublishedApiPath::unsetCcfIds()
{
    m_CcfIdsIsSet = false;
}
