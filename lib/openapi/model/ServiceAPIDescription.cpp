...
bool ServiceAPIDescription::validate(std::stringstream& msg, const std::string& pathPrefix) const
{
    bool success = true;
    const std::string _pathPrefix = pathPrefix.empty() ? "ServiceAPIDescription" : pathPrefix;
    ...
    if (aefProfilesIsSet())
    {
        ...
        success = value.validate(msg, currentValuePath + ".aefProfiles") && success;
...
bool ServiceAPIDescription::operator==(const ServiceAPIDescription& rhs) const
{
    ...
    ((!apiIdIsSet() && !rhs.apiIdIsSet()) || (apiIdIsSet() && rhs.apiIdIsSet() && getApiId() == rhs.getApiId())) &&
    
    
    ((!aefProfilesIsSet() && !rhs.aefProfilesIsSet()) || (aefProfilesIsSet() && rhs.aefProfilesIsSet() && getAefProfiles() == rhs.getAefProfiles())) &&
    ...
    ((!shareableInfoIsSet() && !rhs.shareableInfoIsSet()) || (shareableInfoIsSet() && rhs.shareableInfoIsSet() && getShareableInfo() == rhs.getShareableInfo())) &&
    
    
    ((!serviceAPICategoryIsSet() && !rhs.serviceAPICategoryIsSet()) || (serviceAPICategoryIsSet() && rhs.serviceAPICategoryIsSet() && getServiceAPICategory() == rhs.getServiceAPICategory())) &&
    
    
    ((!apiSuppFeatsIsSet() && !rhs.apiSuppFeatsIsSet()) || (apiSuppFeatsIsSet() && rhs.apiSuppFeatsIsSet() && getApiSuppFeats() == rhs.getApiSuppFeats())) &&
    
    
    ((!pubApiPathIsSet() && !rhs.pubApiPathIsSet()) || (pubApiPathIsSet() && rhs.pubApiPathIsSet() && getPubApiPath() == rhs.getPubApiPath())) &&
    
    
    ((!ccfIdIsSet() && !rhs.ccfIdIsSet()) || (ccfIdIsSet() && rhs.ccfIdIsSet() && getCcfId() == rhs.getCcfId()))
...
std::string ServiceAPIDescription::getApiName() const
{
    return m_ApiName;
}
...
std::string ServiceAPIDescription::getApiId() const
{
    return m_ApiId;
}
...
bool ServiceAPIDescription::apiIdIsSet() const
{
    return m_ApiIdIsSet;
}
void ServiceAPIDescription::unsetApiId()
{
    m_ApiIdIsSet = false;
}
...
void ServiceAPIDescription::setAefProfiles(std::vector<AefProfile> const& value)
{
    m_AefProfiles = value;
...
void ServiceAPIDescription::unsetAefProfiles()
{
    m_AefProfilesIsSet = false;
}
...
void ServiceAPIDescription::unsetDescription()
{
    m_DescriptionIsSet = false;
}
...
void ServiceAPIDescription::setShareableInfo(ShareableInformation const& value)
{
...
void ServiceAPIDescription::unsetApiSuppFeats()
{
    m_ApiSuppFeatsIsSet = false;
}
...
void ServiceAPIDescription::unsetPubApiPath()
{
    m_PubApiPathIsSet = false;
}
std::string ServiceAPIDescription::getCcfId() const
{
    return m_CcfId;
}
...
bool ServiceAPIDescription::ccfIdIsSet() const
{
    return m_CcfIdIsSet;
}
void ServiceAPIDescription::unsetCcfId()
{
    m_CcfIdIsSet = false;
}
